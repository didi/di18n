...
import { default as i18n } from './ReactIntlUniversal';
...
export function nodesToString(mem, children, index, i18nOptions) {
  ...
  children.forEach((child, i) => {
    ...
    if (typeof child === 'string') {
      ...
      const elementTag = keepArray.indexOf(child.type) > -1
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts) {
  ...
  getData(children);
  // targetString = i18n.services.interpolator.interpolate(targetString, { ...data, ...combinedTOpts }, i18n.language);
...
export function Di18nTrans({
  ...
  if (!i18n) {
    console.warn('You will need pass in an intal instance by using di18n-react');
    return children;
  }
  ...
  let translation = key ? i18n.get(key, combinedTOpts) : defaultValue;
